...
;	return res;}
	...
	PSHUFB XMM0, [pixel0BGR] 	; ordeno en el registro los pixels de forma 0BGR (tengo 4 pixeles)
	...
	PAND XMM1 ,[colores1] 		; estos pixeles le ponemos colores[4]
